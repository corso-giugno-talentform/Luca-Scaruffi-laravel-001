<x-main title="Homepage - Il Mio Portfolio">
    <section class="bg-light text-dark text-center py-5 py-md-5 py-lg-6 mt-5 fade-in">
        <div class="container py-5">
            ...
            <div class="mt-4">
                <a href="{{ route('projects.index') }}" class="btn btn-primary btn-lg mx-2 mb-2">Esplora i Miei
                    Progetti <i class="bi bi-arrow-right"></i></a>
                <a href="{{ route('about') }}" class="btn btn-outline-primary btn-lg mx-2 mb-2">Scopri Chi Sono <i
                        class="bi bi-person"></i></a>
            </div>
        </div>
    </section>

    <section class="py-5 bg-body-tertiary fade-in">
        <div class="container">
            <h2 class="text-center fw-bold mb-5 display-5">Perché Scegliermi?</h2>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    <div class="card h-100 shadow-sm text-center p-4 border-light rounded-3">
                        <div class="card-body">
                    ...
                    <div class="card h-100 shadow-sm text-center p-4 border-light rounded-3">
                        <div class="card-body">
                            ...
                            <a href="{{ route('services.show', ['slug' => 'sviluppo-website-e-web-app']) }}"
                                class="btn btn-sm btn-outline-primary mt-3">Scopri di più</a>
                        </div>
                    </div>
                </div>
                <div class="col">
    ...
    <section class="py-5 text-center bg-body-tertiary fade-in">
        <div class="container">
